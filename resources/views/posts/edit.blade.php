...
@section('content')
    ...
    <div class="row col-8 offset-2">
        <div class="form-group mt-4">
            ...
            {!! Form::label('prefectures','都道府県（必須）') !!}
            ...
            <div class="form-check">
                {!! Form::checkbox('drums',true,$post->drums,['class'=>'form-check-input']) !!}
                {!! Form::label('drums','ドラム') !!}
            </div>
            <div class="form-check">
                {!! Form::checkbox('keyboard',true,$post->keyboard,['class'=>'form-check-input']) !!}
    ...
    <div class="d-grid col-1 mx-auto mt-5">
        {!! Form::submit('再投稿',['class'=>'btn btn-danger btn-lg btn-block','onClick'=>'return check()']) !!}
    </div>
    {!! Form::close() !!}

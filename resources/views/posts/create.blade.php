...
@section('content')
    ...
    <div class="row col-8 offset-2">
        <div class="form-group mt-4">
            ...
            <div class="form-check">
                {!! Form::checkbox('drums',true,false,['class'=>'form-check-input']) !!}
                {!! Form::label('drums','ドラム') !!}
            </div>
            <div class="form-check">
                {!! Form::checkbox('keyboard',true,false,['class'=>'form-check-input']) !!}
    ...
    <div class="d-grid col-1 mx-auto mt-5">
        {!! Form::submit('投稿',['class'=>'btn btn-danger btn-lg btn-block','onClick'=>'return check()']) !!}
    </div>
    {!! Form::close() !!}
